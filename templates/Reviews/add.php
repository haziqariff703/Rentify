...
<div class="add-review-container">
    ...
    <div class="page-header">
        <div>
            <h2><?= __('New Review') ?></h2>
            <p class="text-muted"><?= __('Add a new customer review') ?></p>
        </div>
    ...
    <div class="form-card">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <?= $this->Form->control('rating', ['label' => false, 'type' => 'number', 'min' => 1, 'max' => 5, 'class' => 'form-control', 'placeholder' => 'Enter rating (1-5)']) ?>
                <small class="text-muted">Enter a rating from 1 to 5</small>
            </div>

            <div class="form-group">
                <label><i class="fas fa-comment me-2"></i><?= __('Comment') ?></label>
                <?= $this->Form->control('comment', ['label' => false, 'type' => 'textarea', 'rows' => 4, 'class' => 'form-control', 'placeholder' => 'Enter customer review comment...']) ?>
            </div>
