...
<div class="edit-invoice-container">
    ...
    <div class="page-header">
        <div>
            <h2><?= __('Edit Invoice') ?> #<?= h($invoice->id) ?></h2>
            <p class="text-muted"><?= __('Update invoice details') ?></p>
        </div>
        <div class="header-actions">
            <?= $this->Form->postLink(
                '<i class="fas fa-trash me-2"></i>' . __('Delete'),
                ['action' => 'delete', $invoice->id],
                ['confirm' => __('Are you sure you want to delete #{0}?', $invoice->id), 'class' => 'btn btn-outline-danger', 'escape' => false]
            ) ?>
            <?= $this->Html->link(
        ...
        <div class="card-body">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <?= $this->Form->control('invoice_number', ['label' => false, 'class' => 'form-control']) ?>
                </div>
            </div>
