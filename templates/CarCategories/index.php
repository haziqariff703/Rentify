        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions">
                        <?= $this->Html->link(__('View'), ['action' => 'view', $carCategory->id]) ?>
                        <?= $this->Html->link(__('Edit'), ['action' => 'edit', $carCategory->id]) ?>
                        <?= $this->Form->postLink(
                            __('Delete'),
                            ['action' => 'delete', $carCategory->id],
                            [
                                'method' => 'delete',
                                'confirm' => __('Are you sure you want to delete # {0}?', $carCategory->id),
                            ]
                        ) ?>
                    </td>
                </tr>
