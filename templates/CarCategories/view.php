...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Html->link(__('Edit Car Category'), ['action' => 'edit', $carCategory->id], ['class' => 'side-nav-item']) ?>
            <?= $this->Form->postLink(__('Delete Car Category'), ['action' => 'delete', $carCategory->id], ['confirm' => __('Are you sure you want to delete # {0}?', $carCategory->id), 'class' => 'side-nav-item']) ?>
    ...
    <div class="column column-80">
        <div class="carCategories view content">
            ...
            <table>
                ...
                <tr>
                    <th><?= __('Id') ?></th>
                    <td><?= $this->Number->format($carCategory->id) ?></td>
                </tr>
                <tr>
                    <th><?= __('Created') ?></th>
