                ...
                <div class="mb-3">
                    ...
                    <div class="color-picker-group">
                        <?= $this->Form->control('badge_color', [
                            ...
                            'label' => false,
                            'id' => 'badgeColorPicker',
                            'value' => $carCategory->badge_color ?? '#3b82f6',
                            'class' => 'form-control form-control-color'
                        ]) ?>
                        <span class="color-preview" id="colorPreview" style="background: <?= h($carCategory->badge_color ?? '#3b82f6') ?>;"><?= h($carCategory->badge_color ?? '#3b82f6') ?></span>
                    </div>
