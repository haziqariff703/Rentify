...
/**
 * Sliding Registration/Login Page - Registration First Design
...
<div class="auth-slider-page">
    <div class="auth-container right-panel-active" id="container">
        <!-- Login Form (hidden initially, slides in when "Login" clicked) -->
        <div class="form-container login-container">
            ...
            <div class="form-group password-group">
                ...
                <i class="fas fa-eye password-toggle" data-target="add-login-password"></i>
            </div>
        ...
        <div class="form-container register-container">
            ...
            <div class="form-group password-group">
                ...
                <?= $this->Form->control('password', [
                    ...
                    'type' => 'password',
                    'required' => true,
                    'id' => 'add-register-password'
                ]) ?>
                <i class="fas fa-eye password-toggle" data-target="add-register-password"></i>
            </div>
        ...
        <div class="overlay-container">
            <div class="overlay">
                <!-- Left Overlay Panel (shows when on Register - visible first) -->
...
<style>
    ...
    @media (max-width: 768px) {
        ...
        /* When NOT active (login visible) on mobile */
        .auth-container:not(.right-panel-active) .login-container {
            display: block;
        }

        .auth-container:not(.right-panel-active) .register-container {
            display: none;
        }
