...
<div class="edit-payment-container">
    ...
    <div class="page-header">
        <div>
            <h2><?= __('Edit Payment') ?> #<?= h($payment->id) ?></h2>
            <p class="text-muted"><?= __('Update payment details') ?></p>
        </div>
    ...
    <div class="form-card">
        <div class="card-header">
            <h5><i class="fas fa-credit-card me-2"></i><?= __('Payment Information') ?></h5>
        </div>
        <div class="card-body">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <?= $this->Form->control('amount', ['label' => false, 'type' => 'number', 'step' => '0.01', 'class' => 'form-control']) ?>
                </div>
                <div class="form-group">
                    <label><i class="fas fa-credit-card me-2"></i><?= __('Payment Method') ?></label>
                    <?= $this->Form->control('payment_method', ['label' => false, 'class' => 'form-control']) ?>
                </div>
            </div>

            <div class="form-row">
                <div class="form-group">
                    <label><i class="fas fa-calendar-alt me-2"></i><?= __('Payment Date') ?></label>
                    <?= $this->Form->control('payment_date', ['label' => false, 'class' => 'form-control']) ?>
                </div>
                <div class="form-group">
                    <label><i class="fas fa-check-circle me-2"></i><?= __('Status') ?></label>
                    <?= $this->Form->control('payment_status', ['label' => false, 'class' => 'form-control']) ?>
                </div>
            </div>
