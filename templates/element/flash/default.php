...
$id = 'toast-' . uniqid();
?>
<div id="<?= $id ?>" class="toast show shadow-lg overflow-hidden" role="alert" aria-live="assertive" aria-atomic="true" style="min-width: 350px; background-color: #6c757d; color: white; border: none; border-radius: 8px;">
