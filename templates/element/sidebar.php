...
<div class="glassmorphism-sidebar" id="sidebar">
    ...
    <ul class="sidebar-menu" id="sidebarMenu">
        ...
        <li class="sidebar-menu-item">
            <a href="<?= $this->Url->build(['controller' => 'Bookings', 'action' => 'index']) ?>" class="sidebar-menu-link <?= ($this->request->getParam('controller') == 'Bookings') ? 'active' : '' ?>" data-index="2">
        ...
        <li class="sidebar-menu-item">
            <a href="<?= $this->Url->build(['controller' => 'Reviews', 'action' => 'index']) ?>" class="sidebar-menu-link <?= ($this->request->getParam('controller') == 'Reviews') ? 'active' : '' ?>" data-index="5">
        ...
        <li class="sidebar-menu-item">
            <a href="<?= $this->Url->build(['controller' => 'Payments', 'action' => 'index']) ?>" class="sidebar-menu-link <?= ($this->request->getParam('controller') == 'Payments') ? 'active' : '' ?>" data-index="6">
