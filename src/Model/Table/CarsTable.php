 ...
 * Cars Model
 *
 * @property \App\Model\Table\CarCategoriesTable&\Cake\ORM\Association\BelongsTo $CarCategories
 *
...
class CarsTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        $validator
            ...
            ->allowEmptyString('car_category_id');
    ...
    public function buildRules(RulesChecker $rules): RulesChecker
    {
        ...
        $rules->add($rules->existsIn(['car_category_id'], 'CarCategories'), ['errorField' => 'car_category_id']);
