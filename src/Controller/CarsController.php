...
class CarsController extends AppController
{
    ...
    {
        $car = $this->Cars->get($id, contain: ['CarCategories']);
    ...
    public function add()
    {
        ...
        $carCategories = $this->Cars->CarCategories->find('list', limit: 200)->all();
        $this->set(compact('car', 'carCategories'));
    }
